...
function onEvent(event) {
	if (event.event.name == 'Change_Character') {
		...
		//trace(newChar.curCharacter);
		if (params.charIndex == 0) {
			if (params.strumIndex == 0) newChar.getHasAnimIcon(newChar.curCharacter)?iconP2.setIcon(newChar.curCharacter):iconP2.setIcon(newChar.getIcon());
			else if (params.strumIndex == 1)newChar.getHasAnimIcon(newChar.curCharacter)?iconP1.setIcon(newChar.curCharacter):iconP1.setIcon(newChar.getIcon());
		}
